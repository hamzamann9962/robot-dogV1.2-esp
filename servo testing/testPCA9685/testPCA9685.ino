...
byte PWM_pin[PWM_NUM] = {
  // User robot mapping: RF 0,1,2 | (skip 3) | LF 4,5,6 | (skip 7) | RR 8,9,10 | LR 11,12,13
  // Fill remaining indices with the unused/skipped channels so code that expects 16 entries still works.
  0, 1, 2,    // 0..2  (RF)
  4, 5, 6,    // 3..5  (LF)
  8, 9, 10,   // 6..8  (RR)
  11, 12, 13, // 9..11 (LR)
  14, 15, 3, 7 // 12..15 (unused / skipped channels)
};
